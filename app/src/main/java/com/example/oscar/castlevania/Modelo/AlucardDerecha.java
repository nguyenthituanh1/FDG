 ...
 */
public class AlucardDerecha extends View
{
    ...
    public AlucardDerecha(Context context, int x, int y) {
        super(context);
        this.x=x;
        this.y=y;
        init(context);
    ...
    {
        setFocusable(true);
        gifInputStream = context.getResources().openRawResource(R.drawable.alucardderecha);
